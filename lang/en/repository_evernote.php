...
$string['sslcompatibilitymode'] = 'SSL compatibility mode';
$string['sslcompatibilitymode_help'] = 'This is highly discouraged but on some installations there is a bug with OpenSSL. Enabling this option will force SSL version 3 <strong>or</strong> use HTTP instead HTTPS depending of the case. See <a href="http://discussion.evernote.com/topic/26978-ssl-handshake-problems">this topic</a>. Requires Moodle 2.3.2.';
